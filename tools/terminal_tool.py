...
def terminal_tool(
    ...
    try:
        ...
        if background:
            # Resolve the complete notification contract before spawning. The
            # registry persists this record before the command is allowed to
            # run, closing the fast-exit/checkpoint race.
            ...
            if notify_on_complete or watch_patterns:
                ...
                if not _async_ok():
                    ...
                    notification = {
                        ...
                        "session_id": _gse("HERMES_SESSION_ID", ""),
                        "profile": _gse("HERMES_SESSION_PROFILE", ""),
                        "check_interval": 5 if _gw_platform else 0,
                        "notify_on_complete": bool(notify_on_complete),
        ...
        if background:
            ...
            try:
                ...
                if not notify_on_complete and not watch_patterns and notification is None:
                    # Distinguish an unsupported async endpoint from an ordinary
                ...
                if notify_on_complete and background:
                    ...
                    if proc_session.watcher_platform:
                        process_registry.pending_watchers.append(
                            process_registry._watcher_for_session(proc_session)
                        )
